...
class UpdatePassword extends StatefulWidget {
  ...
  const UpdatePassword({super.key, required this.customerId}); // Thêm tham số customerId
...
class _UpdatePasswordState extends State<UpdatePassword> {
  ...
  final PasswordResetService _passwordResetService = PasswordResetService(); // Khởi tạo service
            ...
            children: [
              ...
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                  ...
                  padding: const EdgeInsets.symmetric(vertical: 12), // Optional: Padding
                ),
                onPressed: () {
                ...
                child: const Text(
                  'Cập nhật mật khẩu',
                  style: TextStyle(fontSize: 18, color: Colors.white), // Ensure text is readable
                ),
              )
            ],
          ),
